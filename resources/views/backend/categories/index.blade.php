            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-warning btn-sm" href="{{ route('backend.admin.categories.edit', $category->id) }}">Edit</a>
                  <form action="{{ route('backend.admin.categories.destroy', $category->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
