    ...
    <form action="{{ route('backend.admin.brands.update',$brand->id) }}" method="post" class="accountForm"
      ...
      <div class="card-body row">
        ...
        <div class="mb-3">
          ...
          <input type="file" class="form-control" name="brand_image" id="thumbnailInput">
        ...
        <div class="mb-3 col-md-12">
          ...
          <textarea class="form-control" placeholder="Enter description" name="description" required>{{ old('description',$brand->description) }}</textarea>
        </div>
        <div class="mb-3 col-md-12">
