    ...
    <form action="{{ route('backend.admin.customers.update',$customer->id) }}" method="post" class="accountForm"
      ...
      <div class="card-body row">
        ...
        <div class="mb-3 col-md-12">
          ...
          <textarea class="form-control" placeholder="Enter description" name="description">{{ old('description',$customer->description) }}</textarea>
        </div>
        <div class="mb-3 col-md-12">
          <div class="form-switch">
            <input type="hidden" name="status" value="0">
            <input class="form-check-input" type="checkbox" name="status" id="active"
              value="1" @if($customer->status==1) checked @endif>
